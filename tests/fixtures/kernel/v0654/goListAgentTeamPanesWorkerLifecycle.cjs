const GO_LIST_AGENTTEAM_PANES_WORKER_LIFECYCLE_SCHEMA_VERSION = 1
const GO_LIST_AGENTTEAM_PANES_WORKER_LIFECYCLE_THEME = 'v0.6.54 Go listAgentTeamPanes worker lifecycle slice'
...
const CAPABILITY_ADVERTISEMENT_DECISION = 'advertise-workerLifecycle-for-read-only-inspect-and-list-agentteam-panes'
const WORKER_LIFECYCLE_STATUS = 'runtime-read-only-inspect-and-list-agentteam-panes'
...
const COMPACT_LIST_RESULT_FIELDS = Object.freeze([
  'ok',
  'operation',
  'capability',
  'panes',
...
const COMPACT_PANE_FIELDS = Object.freeze([
  'paneId',
  'target',
  'label',
  'currentCommand',
...
const goListAgentTeamPanesWorkerLifecycle = Object.freeze({
  schemaVersion: GO_LIST_AGENTTEAM_PANES_WORKER_LIFECYCLE_SCHEMA_VERSION,
  theme: GO_LIST_AGENTTEAM_PANES_WORKER_LIFECYCLE_THEME,
  ...
  compactListResultFields: COMPACT_LIST_RESULT_FIELDS,
  compactPaneFields: COMPACT_PANE_FIELDS,
  unsupportedOperations: UNSUPPORTED_OPERATIONS,
  inspectPaneReadOnly: true,
  listAgentTeamPanesReadOnly: true,
  listAgentTeamPanesRequiresNonEmptyLabel: true,
  listAgentTeamPanesByPaneIdFilteredOnly: true,
