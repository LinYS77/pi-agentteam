...
const STEP6_BATCH3_CLUSTERS = Object.freeze({
  ...
  teammatePaneLifecycleMutation: Object.freeze({
    ...
    expectedSuiteCount: 8,
    recommendedAction: 'split-later',
    rationale: 'Step 6 batch 4 deletes replaced high-risk creation lifecycle gate/cutover suites after current guard migration proves exact createTeammatePane/new-session/new-window argv, compact throwing failures, and no wake/send-keys/destructive lifecycle expansion; destructive kill-pane v0685-v0686 remains retained.',
  }),
