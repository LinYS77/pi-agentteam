...
const STEP6_BATCH3_CLUSTERS = Object.freeze({
  ...
  readOnlyFacade: Object.freeze({
    ...
    rationale: 'Step 6 batch 1 deletes the five low-risk sync pane facade wrappers after current guard migration; v0660-v0670 retain distinct current-binding/window/session behavior for later review.',
  }),
