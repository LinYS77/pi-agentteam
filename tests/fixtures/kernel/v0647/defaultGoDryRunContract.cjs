...
const DRY_RUN_RUNTIME_PATH = Object.freeze({
  ...
  futureResolverMode: 'future-default-go-dry-run',
...
const defaultGoDryRunContract = Object.freeze({
  ...
  recommendation: 'v0.6.47 implements the non-mutating default-Go dry-run verifier path. It remains ready:false and is not approval for actual default Go, default resolver enablement, TypeScript fallback deletion, native/package/release work, npm/tag/release actions, or v0.7 release-ready status.',
})
