const VALID_KERNEL_MODES = new Set(['disabled', 'typescript', 'go', 'auto', 'go-cutover', 'go-packaged-preview'])
...
const KERNEL_CAPABILITIES = ['health', 'profile', 'tmuxSnapshotParse', 'tmuxSnapshotCapture', 'compactReadModelFingerprint', 'workerLifecycle', 'tmuxAvailability']
