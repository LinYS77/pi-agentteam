...
- 距离方案书 v0.5 的 `core refactor + performance baseline + bug burn-down release`：约 55–65% 完成。identity/state/read-model/tmux/panel/report/config 的基础 guard 和 baseline 已大量完成，但最终 p95 release gate、P0 bug burn-down checklist、manual RC smoke 仍需闭环。
