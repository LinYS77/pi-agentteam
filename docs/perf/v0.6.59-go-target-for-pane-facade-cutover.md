...
- `captureCurrentPaneBinding()` is cut over separately by v0.6.60; window helpers are cut over separately by v0.6.62 through a cancellable async Go `listPanesInWindow` seam.
