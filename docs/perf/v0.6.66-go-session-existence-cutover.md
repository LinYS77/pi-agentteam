...
- `ensureSwarmWindow()` still owns `new-session`, `new-window`, post-creation window lookup, pane setup list-panes, display-message current target fallback, marking, and label refresh.
