...
- `paneExists()` is cut over separately by v0.6.57; `resolvePaneBinding()`, `targetForPaneId()`, and `captureCurrentPaneBinding()` are later cut over by v0.6.58-v0.6.60; window helpers remain TypeScript-owned.
