...
- [ ] Optional Go kernel checkpoint sanity
  - Review `docs/perf/go-kernel-slice7-checkpoint.md` for benchmark-only shadow diagnostics and commands, `docs/perf/v0.4.17-kernel-contract-hardening.md` for the frozen optional-helper contract, and `docs/perf/v0.4.17-kernel-release-checklist.md` for the GitHub-only v0.4.17 checklist; do not expose those diagnostics in `/team`, add native binaries, run `npm version`, run `npm publish`, or make Go required/default for runtime.
