...
import { getMailboxPath, getTeamStatePath } from '../../state/paths.js'
import { validateOrQuarantineTeam } from '../../state/validation.js'
...
export function ensureTeamStorageReady(team: TeamState): void {
  if (validateOrQuarantineTeam(team.name)) return
